...
; 0014 - 10/30/05 - add movement structure, movement queue window, unified color representation
;
; to-do's
...
;   add movement points back after delete
;   figure out how to unselect entire movement list
...
bweep=LoadSound("media/newalert.wav")
...
btnQuit = Button( 32, 85, 138, 27, "Quit", "0", 1, 0, 0 )
...
MessageBox("You begin a new turn in the Ibex dimension.  You have "+pmovemax+" movement points to spend.","A New day...")
	...
	Select app\Event
		...
		Case EVENT_GADGET
			Select app\GadgetEvent
				Case btnQuit
				  if messagebox("Are you sure?","Confirm Quit",2)="Yes" then app\quit=True
				Case btnMap
				...
				Case btnQDel
					...
					Else
						...
						sendmessage(lstmoves,"lp_setinfex",0)
						updatemap()
						sendmessage(imgmap,"im_setimage",mapimg)
					End If
